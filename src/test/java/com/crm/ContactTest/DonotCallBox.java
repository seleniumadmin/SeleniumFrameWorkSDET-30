...
public class DonotCallBox {
	@Test
	public void donotCollBox() throws Throwable {
			...
			/*step5:create a contact and check donot call box*/
			driver.findElement(By.name("lastname")).sendKeys(LastName);
			//driver.findElement(By.id("email")).sendKeys(EmailId);
			
		 
			WebElement checkbox=driver.findElement(By.name("donotcall"));
