...
public class PortalUserBox {
	@Test
	public void portalUserBox() throws Throwable {
		...
		Cell cel=ro.getCell(2);
	     ...
	     String EmailId=cel.getStringCellValue();
		...
		/*step5:create a contact and check portal username*/
		driver.findElement(By.name("lastname")).sendKeys(LastName);
		driver.findElement(By.id("email")).sendKeys(EmailId);
		
		//WebElement checkbox=driver.findElement(By.name("portal")).click();
		WebElement checkbox=driver.findElement(By.name("portal"));
